...
public class ParserGCIs {
	...
	public ArrayList<OWLAxiom> parseFile() throws IOException, OntException {
		...
		for(String line: lines) {
			...
			axiomsToGcis.put(a.toString(), line);
			result.add(a);
		}
		return result;
	}
	...
	public HashMap<String, String> getMappingAxiomsToGcis() {
		return axiomsToGcis;
	}
	
	
	public HashSet<String> getExtractedClassNames() {
		return extractedClassNames;
	}
	
	
	public HashSet<String> getExtractedPropertyNames() {
		return extractedPropertyNames;
	}
